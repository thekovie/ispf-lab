...
| `tests/tutorial/lessons.test.ts` | 15 lessons registered, no personal names, lesson 2 both routes + detour + scoring, lesson 8 catalog validation, lesson 9 line commands, lesson 14 challenge mode, lesson 6 allocation, lesson 15 split screen |
