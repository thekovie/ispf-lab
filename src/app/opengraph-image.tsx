      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", flex: 1 }}>
          ...
          <div style={{ display: "flex", color: "#b9c5d0", fontSize: 19, lineHeight: 1.45, marginTop: 20 }}>
            A browser-based simulator of the z/OS ISPF workflow: option 3.4, member lists, the editor and its line commands — with 28 lessons that check what you actually do.
          </div>
